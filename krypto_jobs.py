...
# Method to display the database of KryptoJobs2Go candidate information
def get_people():
    ...
    for number in range(len(people)):
        # Display candidate information on streamlit front-end
...
# Calculating and sacing the candidates wage
